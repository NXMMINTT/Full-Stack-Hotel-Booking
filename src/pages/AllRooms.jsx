            ...
            {roomsDummyData.map((room) => (
                <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
                    <img onClick={()=> {navigate(`/rooms/${room._id}`) ; scrollTo(0,0)}}
                     src={room.images[0]} alt="hotel-img" title='View Room Details' className='max-h-56 md:max-h-65 md:max-w-1/2 rounded-xl shadow-lg object-cover cursor-pointer' />
                    ...
                    <div className='md:w-1/2 flex flex-col gap-2'> 
                        ...
                        <div className='flex items-center gap-1 text-gray-500 mt-2 text-sm'>
                            ...
                            <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'> {room.amenities.map((item, index) => (
                                ...
                                <div key={index} className='flex flex-wrap items-center gap-2 px-3 py-2 rounded-lg bg-[#F5F5FF]/70'>

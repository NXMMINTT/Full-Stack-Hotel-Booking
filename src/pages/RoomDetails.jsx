...
const RoomDetails = () => {
  ...
  return  room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
          ...
          <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
              ...
              <div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div>
               <div className='flex flex-col'>
                ...
                <input type="number" id='guests' placeholder='Number of Guests' className='max-w-20 rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none' required/>
              </div>

          </div>

          <button type='submit' className='bg-primary hover:bg-primary-dullactive:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer'>
            Check Availability
          </button>
        </form>
        ...
        <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-shadow-gray-500'>
          <p>
        ...
        {/* Hosted by */}
          <div className='flex flex-col items-start gap-4'>
            ...
            <button className='bg-primary hover:bg-primary-dullactive:scale-95 transition-all text-white rounded-md px-6 py-2 text-base cursor-pointer'>Contact Host</button>
